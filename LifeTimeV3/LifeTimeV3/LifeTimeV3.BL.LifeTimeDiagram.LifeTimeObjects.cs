...
namespace LifeTimeV3.BL.LifeTimeDiagram
{
    partial class LifeTimeDiagramEditor
    {
        ...
        public abstract class ILifeTimeObject
        {
            public abstract List<String> Properties(bool All);
            public const String XmlNodeName = "";
        ...
        /// </summary>
        public class LifeTimeElement : ILifeTimeObject
        {
            #region Enumerators
            ...
            public new const String XmlNodeName = "Object";
        ...
        /// </summary>
        public class LifeTimeGroup : ILifeTimeObject
        {
            #region Propierties
            /// <summary>
            /// Returns a list of available properties
            ...
            public new const String XmlNodeName = "Group";
        ...
        /// </summary>
        public class LifeTimeDiagramSettings : ILifeTimeObject
        {
            #region Enumerators
            #endregion
            ...
            public new const String XmlNodeName = "DiagramSettings";
        ...
        /// </summary>
        public class LifeTimeExportSettings : ILifeTimeObject
        {
            #region Enumerators
            #endregion
            ...
            public new const String XmlNodeName = "ExportSettings";
        ...
        public class LifeTimeXmlObject
        {
            ...
            /// <param name="o"></param>
            /// <returns></returns>
            public XmlElement GetXmlFromObject<T>(T o)
            {
                XmlElement e = null;
                if (o is LifeTimeElement) e = Xml.CreateElement(LifeTimeElement.XmlNodeName);
                else if (o is LifeTimeGroup) e = Xml.CreateElement(LifeTimeGroup.XmlNodeName);
                else if (o is LifeTimeDiagramSettings) e = Xml.CreateElement(LifeTimeDiagramSettings.XmlNodeName);
                else if (o is LifeTimeExportSettings) e = Xml.CreateElement(LifeTimeExportSettings.XmlNodeName);
                else throw new Exception("No LifeTimeObject was given!");

                Type t = typeof(T);

                foreach (string property in (o as ILifeTimeObject).Properties(true))
                {
                    if (t.GetProperty(property).GetValue(o) is Color) e.SetAttribute(property, ConvertColorToString((Color)(t.GetProperty(property).GetValue(o))));
                    else e.SetAttribute(property, t.GetProperty(property).GetValue(o).ToString());
                }
            ...
            /// <returns></returns>
            public ILifeTimeObject GetObjectFromXml<T>(XmlNode node)
            {
                ILifeTimeObject o = null;
                Type t = typeof(T);

                switch (node.Name)
                {
                    case LifeTimeElement.XmlNodeName:
                ...
                foreach (String property in o.Properties(true))
                {
                    ...
                    if (t.GetProperty(property).PropertyType == typeof(bool))
                        t.GetProperty(property).SetValue(o, Convert.ToBoolean(node.Attributes[property].Value));
