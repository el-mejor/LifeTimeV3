...
namespace LifeTimeV3.Src
{
    ...
    {   
        ...
        string[] ListDE = {
                              ...
                              "[303]", "Element: \"{0}\" - Begann vor {1} Jahren ({2} Tage), dauerte {3} Jahre ({4} Tage)",
                              ...
                              "TextColor", "Textfarbe",
                              "UseGlobalTextColor", "Schriftfarbe auto",
                              "Opacity", "Transparenz",
        ...
        string[] ListEN = {
                              ...
                              "[303]", "Element: \"{0}\" - Began {1} years ({2} days) ago, lasted for {3} years ({4} days)",
                              ...
                              "TextColor", "Textcolor",
                              "UseGlobalTextColor", "Auto textcolor",
                              "Opacity", "Opacity",
