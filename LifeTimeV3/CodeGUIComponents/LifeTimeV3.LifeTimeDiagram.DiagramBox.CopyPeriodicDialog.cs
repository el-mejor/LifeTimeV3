...
namespace LifeTimeV3.LifeTimeDiagram.DiagramBox.CopyPeriodicDialog
{
    ...
    {
        #region properties
        public LifeTimeDiagramEditor.LifeTimeElement OriginElement
        { get; set; }
        ...
        public FormCopyPeriodicDialog(LifeTimeDiagramEditor.ILifeTimeObject element)
        {
            ...
            OriginElement = element as LifeTimeDiagramEditor.LifeTimeElement;

            //Setup default values
            PeriodBase = LifeTimeDiagramEditor.PeriodBaseEnum.Years;
            Period = 1;
            AmmountOfCopies = 10;
            LimitForAddingCopies = OriginElement.Begin.AddYears(10);
            ...
            labelElement.Text = $"Element: {OriginElement.Name}";
